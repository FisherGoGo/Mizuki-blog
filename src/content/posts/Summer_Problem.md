...
- 那么就有转移公式
$$\begin{cases} dp_{i,1}=\min\{dp_{i-1,1}+\max\{0,c_{i,1}-c_{i-1,1},dp_{i-1,0}+\max\{0,c_{i,1}-c_{i-1,0}\}\}\}\\ \\dp_{i,0}=\min\{dp_{i-1,1}+\max\{0,c_{i,0}-c_{i-1,1},dp_{i-1,0}+\max\{0,c_{i,0}-c_{i-1,0}\}\}\}\end{cases}$$
