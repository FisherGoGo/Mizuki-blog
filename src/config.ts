...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "Fisher", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/avatar2.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Fisher",
	bio: "Do Whatever just to Stay Alive",
	links: [
		{
			name: "Bilibli",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/354268401",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
